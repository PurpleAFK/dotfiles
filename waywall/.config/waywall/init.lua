...
local mirrors = {
	...
	thin_pie_all = make_mirror({
		src = cfg.res_1440 and { x = 10, y = 694, w = 340, h = 221 } or { x = 0, y = 674, w = 340, h = 221 },
		dst = {
			x = cfg.thin_pie.x,
			y = cfg.thin_pie.y,
	...
	thin_pie_blockentities = make_mirror({
		src = cfg.res_1440 and { x = 10, y = 694, w = 340, h = 178 } or { x = 0, y = 674, w = 340, h = 178 },
		dst = {
			x = cfg.thin_pie.x,
			y = cfg.thin_pie.y,
			w = 420 * cfg.thin_pie.size / 4,
	...
	thin_percent_all = make_mirror({
		src = cfg.res_1440 and { x = 257, y = 879, w = 33, h = 25 } or { x = 247, y = 859, w = 33, h = 25 },
		dst = {
	...
	eye_measure = make_mirror({
		src = cfg.stretched_measure and { x = 177, y = 7902, w = 30, h = 580 }
			or { x = 162, y = 7902, w = 60, h = 580 },
		dst = cfg.res_1440 and { x = 94, y = 470, w = 900, h = 500 } or { x = 30, y = 340, w = 700, h = 400 },
	}),
}
...
local images = {
	...
	tall_overlay = make_image(tall_overlay_path, {
		dst = cfg.res_1440 and { x = 0, y = 0, w = 2560, h = 1440 } or { x = 0, y = 0, w = 1920, h = 1080 },
	}),
